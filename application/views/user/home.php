...
<head>
  ...
  <title>RS BHAYANGKARA BATAM </title>
  <link rel="shortcut icon" href="<?php  echo base_url('assets/user') ?>/img/barulogomi.png">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">SIANOL - Sistem Aplikasi Antrian Online Pasien</a>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Heading -->
      <img class="masthead-avatar mb-5" src="<?php echo base_url('assets/user') ?>/img/barudokkes.png" alt="">
      <h2 class="masthead-heading text-uppercase mb-5">RS Bhayangkara Batam</h2>
      
      
      <div class="row">
          <div class="col-md-12" style="border: thin solid; ">
            <h3>NO ANTRIAN ONLINE SAAT INI</h3>
      ...
      <?php if(!empty($this->session->userdata('id_pasien'))){ ?>
        <div class="row" style="margin-top: 60px">
          ...
          <div class="col-md-3" style="border: thin solid; ">
            ...
            <H6>Poli Anak</H6></div>
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_bedah; ?></h3>
            <H6>Poli Bedah</H6></div>
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_penyakit_dalam; ?></h3>
            <H6>Poli Penyakit Dalam</H6></div>
          <div class="col-md-3" style="border: thin solid; ">
            <h3><?php echo $poli_kandungan; ?></h3>
            <H6>Poli Kandungan</H6></div>
        </div>
      <?php } ?>
      <?php if(empty($this->session->userdata('id_pasien'))){ ?>
        <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di Sistem Aplikasi Online Pasien. 
        <br> Untuk Pendaftaran, silahkan Registrasi terlebih dahulu.</h4>
                ...
                <form action="<?php echo base_url('Index/saveAntrian') ?>" method="post">
                 ...
                 <h6>Keterangan :</h6>
                  <ol>
                    ...
                    <li>Poli Bedah (PLBD)</li>
                    <li>Poli Penyakit Dalam (PLPD) </li>
                    <li>Poli Kandungan (PLOG)</li>
                  </ol>
              </div>
              </div>
    ...
    <div class="container">  
      <div class="row">
        <div class="col-lg-4.ml-auto" align="center" >
          ...
          <p class="lead">Pasien melakukan Registrasi > Input Nomor Identitas, Nomor BPJS, Nama Pasien, Jenis Kelamin, Usia, Tanggal Lahir, Alamat, Nomor Telephone, Username dan Password > Klik Login >  Pilih Poli > Klik Cetak </p>
      </div>
    </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Jl. Dang Merdu No.km.2, Batu Besar, Kecamatan Nongsa
            <br>Kota Batam, Kepulauan Riau 29465</p>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <p class="lead mb-0">(0778) 7760046</p>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('Index/registrasi') ?>" method="post">
            ...
            <div>
                <label >Nomor BPJS <sup>*</sup></label>
                <input type="text" id="no_bpjs" name="no_bpjs" class="form-control" value="" placeholder="Nomor BPJS" required="">
            </div>
