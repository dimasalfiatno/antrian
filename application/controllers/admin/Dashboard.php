        ...
        $getPoli = $this->db->get('kategori_poli')->result();
            foreach ($getPoli as $key) {
                ...
                if($key->id_poli == 1){
                    ...
                    if($antrianpoli){
                        $data['poli_bedah'] = $antrianpoli->no_antrian_poli;
                    ...
                    if($antrianpoli){
                        $data['poli_penyakit_dalam'] = $antrianpoli->no_antrian_poli;

                    }else{
                        $data['poli_penyakit_dalam'] = 0;
                    }
                }elseif($key->id_poli == 6){
                    if($antrianpoli){
                        $data['poli_kandungan'] = $antrianpoli->no_antrian_poli;

                    }else{
                        $data['poli_kandungan'] = 0;
                    }
                // }elseif($key->id_poli == 7){
                //     if($antrianpoli){
                //         $data['poli_anestesi'] = $antrianpoli->no_antrian_poli;

                //     }else{
                //         $data['poli_anestesi'] = 0;
                //     }
                }
            }
